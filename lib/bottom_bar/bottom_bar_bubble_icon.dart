...
import '../clipper/customer_clipper.dart';
import '../components/colors.dart';

typedef BottomBarBubbleIconBuilder = Widget Function(Color color);

class BottomBarBubbleItem {
  final IconData? iconData;
  final double iconSize;
  final String? label;
  final TextStyle? labelTextStyle;
  final double labelMarginTop;
  final BottomBarBubbleIconBuilder? iconBuilder;
...
class BottomBarBubbleIcon extends StatefulWidget {
  ...
  final BottomBarBubbleItem item;
  final Color color;
